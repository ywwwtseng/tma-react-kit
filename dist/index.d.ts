...
import { PropsWithChildren, RefObject, ReactNode, CSSProperties, ReactElement } from 'react';
...
interface TMAProps extends TMAProviderProps, Omit<StackNavigatorProviderProps, 'layout' | 'drawer'>, Omit<TMALayoutProps, 'tabs'> {
